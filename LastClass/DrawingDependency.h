#ifndef _DRAWINGDEPENDENCY_H
#define _DRAWINGDEPENDENCY_H
#include "MouseLButtonAction.h"

class DrawingDependency :public MouseLButtonAction {
public:
...
protected:
	//DrawingClass();
private:
	static DrawingDependency* instance;
};

#endif // !_DRAWINGDEPENDENCY_H
