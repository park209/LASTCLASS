#ifndef _DRAWINGMEMOLINE_H
#define _DRAWINGMEMOLINE_H
#include "MouseLButtonAction.h"

class DrawingMemoLine :public MouseLButtonAction {
public:
...
protected:
	//DrawingClass();
private:
	static DrawingMemoLine* instance;
};

#endif // !_DRAWINGMEMOLINE_H
