...
void PrintPreview::OnPaint() {
	...
	memDC.FillSolidRect(CRect(0, 0, 4000, 2000), RGB(255, 255, 255)); // 제일 아래 바탕흰색
	CFont cFont;
	...
	dc.FillSolidRect(rec, RGB(153, 153, 153)); // 회색 종이
	...
	dc.StretchBlt(rec.left, rec.top - vertCurPos, 600, 800, &memDC, this->horizontalPage, this->verticalPage , 800,1000, SRCCOPY);
