...
void Unclicked::Draw(Selection *selection, Long startX, Long startY, Long currentX, Long currentY, CDC *cPaintDc) {
	...
	if (length == 1 && dynamic_cast<FigureComposite*>(selection->GetAt(0))) {
		...
		if (dynamic_cast<Class*>(object) && static_cast<Class*>(object)->GetTempletePosition() != -1) {
			...
			if (ret == false) { // 좌상단
				rect.left = selectedClass->GetX() - 5;
				rect.top = templete->GetY() - 5;
				rect.right = selectedClass->GetX() + 5;
				rect.bottom = templete->GetY() + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}

			if (ret == false) { // 우상단
				rect.left = templete->GetX() + templete->GetWidth() - 5;
				rect.top = templete->GetY() - 5;
				rect.right = templete->GetX() + templete->GetWidth() + 5;
				rect.bottom = templete->GetY() + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}
			...
			if (ret == false) { // 좌하단
				rect.left = selectedClass->GetX() - 5;
				rect.top = selectedClass->GetY() + selectedClass->GetHeight() - 5;
				rect.right = selectedClass->GetX() + 5;
				rect.bottom = selectedClass->GetY() + selectedClass->GetHeight() + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}
			...
			if (ret == false) { // 상중단
				rect.left = selectedClass->GetX() + (templete->GetX() + templete->GetWidth() - selectedClass->GetX()) / 2 - 5;
				rect.top = templete->GetY() - 5;
				rect.right = selectedClass->GetX() + (templete->GetX() + templete->GetWidth() - selectedClass->GetX()) / 2 + 5;
				rect.bottom = templete->GetY() + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}
			...
			if (ret == false) { // 좌중단
				rect.left = selectedClass->GetX() - 5;
				rect.top = templete->GetY() + (selectedClass->GetY() + selectedClass->GetHeight() - templete->GetY()) / 2 - 5;
				rect.right = selectedClass->GetX() + 5;
				rect.bottom = templete->GetY() + (selectedClass->GetY() + selectedClass->GetHeight() - templete->GetY()) / 2 + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}
			...
			if (ret == false) { // 좌상단
				rect.left = object->GetX() - 5;
				rect.top = object->GetY() - 5;
				rect.right = object->GetX() + 5;
				rect.bottom = object->GetY() + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}

			if (ret == false) { // 우상단
				rect.left = object->GetX() + object->GetWidth() - 5;
				rect.top = object->GetY() - 5;
				rect.right = object->GetX() + object->GetWidth() + 5;
				rect.bottom = object->GetY() + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}
			...
			if (ret == false) { // 좌하단
				rect.left = object->GetX() - 5;
				rect.top = object->GetY() + object->GetHeight() - 5;
				rect.right = object->GetX() + 5;
				rect.bottom = object->GetY() + object->GetHeight() + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}
			...
			if (ret == false) { // 상중단
				rect.left = object->GetX() + object->GetWidth() / 2 - 5;
				rect.top = object->GetY() - 5;
				rect.right = object->GetX() + object->GetWidth() / 2 + 5;
				rect.bottom = object->GetY() + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}
			...
			if (ret == false) { // 좌중단
				rect.left = object->GetX() - 5;
				rect.top = object->GetY() + object->GetHeight() / 2- 5;
				rect.right = object->GetX() + 5;
				rect.bottom = object->GetY() + object->GetHeight() / 2 + 5;
				ret = finder.FindRectangleByPoint(rect, startX, startY);
			}
